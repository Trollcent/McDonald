...
public:
	...
	//void insertFront(T value); // insert the new Node at the front
	//void insertRear(T value); // insert the new Node at the end
	//T lookTop(void) const; // Look at the value at the top
	//T lookBottom(void) const; // Look at the value at the bottom
	//void deleteFront(); // Delete the front node
	//void deleteRear(); // Delete the rear node
...
template <class T>
void LinkedList<T>::insertRear(T value)
{
Node<T> *newNode;
Node<T> *nodePtr;
...
/*
template <class T>
T LinkedList<T>::lookTop(void) const
{
Node *nodePtr;
nodePtr = head;
...
template <class T>
T LinkedList<T>::lookBottom(void) const
{
Node *nodePtr;
if (!head)
{
